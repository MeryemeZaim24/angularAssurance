...
//   private baseUrl = 'http://localhost:8080/api/contrats'; // L'URL de base de votre API
//   private assureBaseUrl = 'http://localhost:8080/api/assures'; // L'URL de base pour l'assuré
//   private apiUrl = 'http://localhost:8080/api/contrats';
//   private apiurl = 'http://localhost:8080/api/contrats/contrats';
...
//     return this.httpClient.get<Contrat[]>(`${this.apiUrl}/sorted`, { params });
//   }
...
//     return this.httpClient.get<Contrat[]>(`${this.apiUrl}/filterByDateRange`, { params });
//   }
...
//     return this.httpClient.get<Contrat[]>(`${this.apiUrl}/filterByExpiration`, { params });
//   }



//   // Méthode pour rechercher par attribut 'police'
//   searchContratsByPolice(police: string): Observable<Contrat[]> {
//     let params = new HttpParams().set('police', police);
