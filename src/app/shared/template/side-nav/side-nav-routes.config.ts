...
export const ROUTES: SideNavInterface[] = [
  ...
  {
    path: '/dashboard/demo-one', // Utilisez le chemin direct ici
    title: 'Dashboard', // Changez le titre en "Dashboard" ou autre nom approprié
    iconType: 'nzIcon',
    iconTheme: 'outline',
    icon: 'appstore-add',
    submenu: [] // Supprimez le sous-menu
  },
  // {
  //   path: '',
